...
public class UserClientFallback implements UserClient {
    ...
    @Override
    public java.util.List<UserResponse> getEmployeesByManagerInternal(Long managerId) {
        log.error("Monolith user service is down/unreachable. Fallback invoked for manager ID: {}", managerId);
        return java.util.List.of();
    }
}
